...
CREATE TABLE IF NOT EXISTS "public"."cash_charges" (
    ...
    CONSTRAINT "cash_charges_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('approved'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."cash_withdrawals" (
    ...
    CONSTRAINT "cash_withdrawals_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('approved'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."coffee_chats" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "coffee_chats_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('accepted'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."moon_charges" (
    ...
    CONSTRAINT "moon_charges_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('approved'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."payment_transactions" (
    ...
    CONSTRAINT "payment_transactions_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('completed'::character varying)::"text", ('cancelled'::character varying)::"text", ('refunded'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."service_orders" (
    ...
    CONSTRAINT "service_orders_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('paid'::character varying)::"text", ('completed'::character varying)::"text", ('cancelled'::character varying)::"text", ('refunded'::character varying)::"text"]))),
