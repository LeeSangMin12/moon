...
declare module '$env/static/private' {
	...
	export const PORT_ONE_SECRET: string;
	...
	export const APPLE_AUTH_KEY: string;
...
declare module '$env/static/public' {
	export const PUBLIC_WEB_CLIENT_URL: string;
	export const PUBLIC_SUPABASE_URL: string;
	export const PUBLIC_SUPABASE_ANON_KEY: string;
	export const PUBLIC_VITE_CLOUDINARY_CLOUD_NAME: string;
	export const PUBLIC_MOBILE_CLIENT_URL: string;
	export const PUBLIC_ANONYMOUS_USER_ID: string;
	export const PUBLIC_PORT_STORE_ID: string;
	export const PUBLIC_PORT_CHANNEL_KEY: string;
	export const PUBLIC_KAKAO_JAVASCRIPT_KEY: string;
}
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_MOBILE_CLIENT_URL: string;
		PUBLIC_ANONYMOUS_USER_ID: string;
		PUBLIC_PORT_STORE_ID: string;
		PUBLIC_PORT_CHANNEL_KEY: string;
		PUBLIC_KAKAO_JAVASCRIPT_KEY: string;
